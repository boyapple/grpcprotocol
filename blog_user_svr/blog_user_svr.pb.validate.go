...
// Validate checks the field values on GetUserStreakReq with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *GetUserStreakReq) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetUserStreakReq with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetUserStreakReqMultiError, or nil if none found.
func (m *GetUserStreakReq) ValidateAll() error {
	return m.validate(true)
}

func (m *GetUserStreakReq) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetUserId() <= 0 {
		err := GetUserStreakReqValidationError{
			field:  "UserId",
	...
	if len(errors) > 0 {
		return GetUserStreakReqMultiError(errors)
	}

	return nil
}

// GetUserStreakReqMultiError is an error wrapping multiple validation errors
// returned by GetUserStreakReq.ValidateAll() if the designated constraints
// aren't met.
type GetUserStreakReqMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetUserStreakReqMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetUserStreakReqMultiError) AllErrors() []error { return m }

// GetUserStreakReqValidationError is the validation error returned by
// GetUserStreakReq.Validate if the designated constraints aren't met.
type GetUserStreakReqValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetUserStreakReqValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetUserStreakReqValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetUserStreakReqValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetUserStreakReqValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetUserStreakReqValidationError) ErrorName() string { return "GetUserStreakReqValidationError" }

// Error satisfies the builtin error interface
func (e GetUserStreakReqValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetUserStreakReq.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetUserStreakReqValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetUserStreakReqValidationError{}

// Validate checks the field values on GetUserStreakRsp with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *GetUserStreakRsp) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetUserStreakRsp with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetUserStreakRspMultiError, or nil if none found.
func (m *GetUserStreakRsp) ValidateAll() error {
	return m.validate(true)
}

func (m *GetUserStreakRsp) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for IsTodayCreate

	if len(errors) > 0 {
		return GetUserStreakRspMultiError(errors)
	}

	return nil
}

// GetUserStreakRspMultiError is an error wrapping multiple validation errors
// returned by GetUserStreakRsp.ValidateAll() if the designated constraints
// aren't met.
type GetUserStreakRspMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetUserStreakRspMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetUserStreakRspMultiError) AllErrors() []error { return m }

// GetUserStreakRspValidationError is the validation error returned by
// GetUserStreakRsp.Validate if the designated constraints aren't met.
type GetUserStreakRspValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetUserStreakRspValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetUserStreakRspValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetUserStreakRspValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetUserStreakRspValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetUserStreakRspValidationError) ErrorName() string { return "GetUserStreakRspValidationError" }

// Error satisfies the builtin error interface
func (e GetUserStreakRspValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetUserStreakRsp.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetUserStreakRspValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetUserStreakRspValidationError{}
